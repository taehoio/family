...
func (_m *IFace) NewAccessToken(_a0 string) (string, error) {
	ret := _m.Called(_a0)
...
func (_m *IFace) NewRefreshToken(_a0 string) (string, error) {
	ret := _m.Called(_a0)
...
func (_m *IFace) ParseToken(_a0 string) (*token.Claims, error) {
	ret := _m.Called(_a0)
...
func (_m *IFace) ValidateToken(_a0 string) error {
	ret := _m.Called(_a0)
