...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.AccountsLogInResponse();
  });
  ...
  describe('AccountsLogInResponse', function() {
    it('should create an instance of AccountsLogInResponse', function() {
      // uncomment below and update the code to test AccountsLogInResponse
      //var instane = new Api.AccountsLogInResponse();
      //expect(instance).to.be.a(Api.AccountsLogInResponse);
    });
