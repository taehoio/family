...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.AuthAuthResponse();
  });
  ...
  describe('AuthAuthResponse', function() {
    it('should create an instance of AuthAuthResponse', function() {
      // uncomment below and update the code to test AuthAuthResponse
      //var instane = new Api.AuthAuthResponse();
      //expect(instance).to.be.a(Api.AuthAuthResponse);
    });
