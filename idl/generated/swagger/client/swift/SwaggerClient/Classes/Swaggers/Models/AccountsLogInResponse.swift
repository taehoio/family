...
open class AccountsLogInResponse: Codable {
    ...
    public init(accessToken: String?, accountId: String?, expiresIn: String?, refreshToken: String?, tokenType: String?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        tokenType = try container.decodeIfPresent(String.self, forKey: "token_type")
    }
}
