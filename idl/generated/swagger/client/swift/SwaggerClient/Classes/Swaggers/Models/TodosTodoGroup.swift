...
open class TodosTodoGroup: Codable {
    ...
    public var permitType: TodosPermitType?
    ...
    public init(createdAt: String?, createdBy: String?, description: String?, order: String?, permitType: TodosPermitType?, title: String?, todoGroupId: String?, updatedAt: String?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        permitType = try container.decodeIfPresent(TodosPermitType.self, forKey: "permit_type")
