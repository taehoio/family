//
// TodosUpdateTodoGroupRequest.swift
//
...
open class TodosUpdateTodoGroupRequest: Codable {
    ...
    public init(accountId: String?, todoGroup: TodosTodoGroup?, todoGroupId: String?) {
