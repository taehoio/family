...
_TODOSSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ListTodo',
    full_name='pb.family.todos.TodosService.ListTodo',
    index=2,
    containing_service=None,
